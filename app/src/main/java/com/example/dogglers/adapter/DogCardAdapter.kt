...
class DogCardAdapter(
    ...
    // TODO-done: Initialize the data using the List found in data/DataSource
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        // TODO-done: Declare and initialize all of the list item UI components
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        // TODO-done: Use a conditional to determine the layout type and set it accordingly.
        //  if the layout variable is Layout.GRID the grid list item should be used. Otherwise the
        //  the vertical/horizontal list item should be used.

        // TODO-done Inflate the layout

        // TODO-done: Null should not be passed into the view holder. This should be updated to reflect
        //  the inflated layout.
    ...
    override fun getItemCount(): Int = data.size // TODO-done: return the size of the data set instead of 0
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.dogAge.text = dogItem.age
